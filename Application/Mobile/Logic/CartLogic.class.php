...
class CartLogic extends RelationModel
{
     ...
     */
    function addCart($goods_id,$goods_num,$goods_spec,$prepay_type,$session_id,$user_id = 0)
    {       
        ...
        $data = array(                    
                    ...
                    'prepay_type'        => $prepay_type,   // 是否预付
                    'prepay_money'        => $goods['prepay_price'],   // 是否预付
    ...
    {                   
        ...
        foreach ($cartList as $k=>$val){
           $goods= M('goods')->where(array('goods_id'=>$val['goods_id']))->find();
            ...
            if($val['prepay_type']==1){
                $total_price += $val['goods_num'] * $val['prepay_money'];
            }else{
