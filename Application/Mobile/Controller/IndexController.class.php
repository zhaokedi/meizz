...
//                'user_id'=> $this->user_id,
            ...
            if($res){
                $this->success('预约成功',U('Mobile/index/index'));
                exit;
            }
        ...
        */
       $now_time = time();
        $hot_goods = M('goods')->where("is_integral=0 and is_hot=1 and is_on_sale=1 and del=0 and (on_time=0 or on_time<$now_time) and (down_time=0 or down_time>$now_time)")->order('goods_id DESC')->limit(4)->select();//首页热卖商品
//        show_bug($hot_goods);
