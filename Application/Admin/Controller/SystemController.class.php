...
class SystemController extends BaseController{
	...
	{
		/*配置列表*/
		$group_list = array('shop_info'=>'网站信息','basic'=>'基本设置','sms'=>'短信设置','shopping'=>'购物流程设置','smtp'=>'邮件设置','water'=>'水印设置','verify_code'=>'验证码设置','indexad'=>'首页广告设置'/*,'distribut'=>'分销设置'*/);
     ...
     */
     public function login_task()
     {
	  ...
	  /**
        * 更新网站地图
        */
    public function ajaxUpdatesitemap(){

			$xml = simplexml_load_file("/sitemap.xml");
			unset($xml->nodedir);//删除$xml根节点即nodedir节点下nodedir节点。
            $xml->asXML("/sitemap.xml");//储存。如只是临时性删除而不保存于文档中，则直接使用
