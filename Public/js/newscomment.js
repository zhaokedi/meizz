	    ...
	    $("#login,#commentContent").livequery(
			...
			function() {
			   $.getJSON(
						...
						function(result)
						{
							if (!result.Identity.IsAuthenticated && confirm("��δ��¼�����ܷ����»��⣬���ڵ�¼��"))
							{
								$.login();
							}
						});
							            ...
							            if (referenceId != "" && title != "") {
							                $.getJSON(
											        ...
											        function(json) {
											            ...
											            if (re.status == 1) {
											                alert(re.info);
											                var newItem = "<div class=\"item\"><div class=\"User\"><span class=\"u-name\">" + re.data.uremark + "</span><span class=\"u-level\">��Ա����<span style=\"color: " + re.data.userLevelColor + ";\">" + re.data.userLevelName + "</span></span><span class=\"date-ask\">" + re.data.creationTime + "</span></div><div class=\"content\">" + re.data.content + "</div></div>";
        ...
        $("#commentinsert").validate(
			{
			    ...
			    messages:
				{
				    commentContent:
						{
						    required: "����д�������ݣ�������4-100λ�ַ�֮��",
						    rangelength: "�������ݳ���ֻ����4-100λ�ַ�֮��",
						    specialWord: "�������ݺ��������ַ�",
						    badWord: "�������ݺ������д���"
						}
				}
